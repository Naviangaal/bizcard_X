...
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By Name ",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Name*!"""})
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        def save_card(uploaded_card):
            with open(os.path.join(r" "), "wb") as f:
